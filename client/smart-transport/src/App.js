      ...
      <form onSubmit={this.handleSubmit}>
        <div class="form-group mb-2">
          <label  class="col-form-label">Vstopno mesto: </label>
            <input class="form-control" value={this.state.from} value="Maribor" type='text'name='from' onChange={this.handleChange} required/>
          </div>
          <div class="form-group mb-2">
          <label class="col-form-label">Izstopno mesto: </label>
            <input class="form-control" value={this.state.to} value="Ptuj" type='text' name='to' onChange={this.handleChange} required/>
          </div>
          <div class="form-group mb-2">
